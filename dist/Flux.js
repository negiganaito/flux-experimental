...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Dispatcher = /*#__PURE__*/function () {
	  ...
	  _proto.register = function register(callback, defaultID) {
	    // var id = _prefix + this._lastID++;

	    var id = this.__genID(defaultID);
	    this._callbacks[id] = callback;
	    return id;
	  };
	  _proto.__genID = function __genID(id) {
	    var _id = id ? id + "_" : _prefix;
	    id = id || _id + this._lastID++;
	    while (this._callbacks.get(id)) {
	      id = _id + this._lastID++;
	    }
	    return id;
	  }
